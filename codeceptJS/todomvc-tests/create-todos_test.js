Feature('@first Create Todos @step:06 @smoke @story:12345 @S66f109fc')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item @T99765262', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items @T68694767', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters @Tf15e88d0', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item @Tcd15a5bb', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed @T7f61f624', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list @T9fc0f6fa', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs @T3740e51e', async ({ I, TodosPage }) => {
