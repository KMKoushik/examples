Feature('Mark as completed/not completed @step-06 @Scf4deafe')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed @Tf8a6ab8e', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos @T25042144', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed @T7013efe2', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @Tc151cd00', async ({ I, TodosPage }) => {
