Feature('Mark as completed/not completed @step-06 @Sb606bd2b')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed @T9e4e711e', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos @Ted9666e5', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed @T37eab15e', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @Tdf916794', async ({ I, TodosPage }) => {
