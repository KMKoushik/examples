Feature('Edit/Delete Todos @step-06 @S64f2ab28')
...
Scenario('Edited todo is saved on blur @T91508e30', async ({ I, TodosPage }) => {
...
Scenario('Delete todos @Te97b71a9', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
