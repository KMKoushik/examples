Feature('Edit/Delete Todos @step-06 @Se3817e7d')
...
Scenario('Edited todo is saved on blur @Tb4b14e2c', async ({ I, TodosPage }) => {
...
Scenario('Delete todos @Tb0758876', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
