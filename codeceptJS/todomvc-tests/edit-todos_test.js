Feature('Edit/Delete Todos @step-06 @Sd8305022')
...
Scenario('Edited todo is saved on blur @Tf9d9c4c3', async ({ I, TodosPage }) => {
...
Scenario('Delete todos @T5159bb0c', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
